...
#define _g _p[5]
#define _ion_ica	*_ppvar[0].pval
#define _ion_cai	*_ppvar[1].pval
	...
	Prop *_prop;
{
	...
	double *_p; Datum *_ppvar;
 	_p = nrn_prop_data_alloc(_mechtype, 6);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  hoc_register_dparam_size(_mechtype, 4);
 	...
 	ivoc_help("help ?1 cad /home/ted/ms/sdsccrs/2008/crsdev/course/modeldb/patdemo/i686/cad.mod\n");
 ...
 v=_v;
{
 ...
 error =  euler(_ninits, 1, _slist1, _dlist1, _p, &t, delta_t, state, &_temp1);
