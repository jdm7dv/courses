...
public:
	...
	XYView(Coord x1, Coord y1, Coord x_span, Coord y_span, Scene*,
	  Coord xsize=200, Coord ysize=200);
	virtual ~XYView();
	...
	const Transformer& s2o()const {return scene2viewparent_;}
	void canvas(Canvas*);
	...
	Coord x_pick_epsilon() {return x_pick_epsilon_;}
	Coord y_pick_epsilon() {return y_pick_epsilon_;}
	...
	Coord view_margin() const {return view_margin_;}
...
private:
	void init(Coord x1, Coord y1, Coord x_span, Coord y_span, Scene*,
...
public:
	...
	View(Coord x, Coord y, Coord span, Scene*,
		Coord xsize = 200, Coord ysize = 200); //x,y is center of view
	View(Coord left, Coord bottom, Coord x_span, Coord y_span, Scene*,
	  Coord xsize=200, Coord ysize=200);
	virtual ~View();
...
inline Coord Scene::x1() const { return x1_; }
inline Coord Scene::x2() const { return x2_; }
inline Coord Scene::y1() const { return y1_; }
inline Coord Scene::y2() const { return y2_; }
