...
#define FAIL                         (cnv) ? cnv : EOF
			switch (*f)
			{
				...
				case '[':
				{
					...
					if (!end) { *rs = s; return FAIL; } /* Could be cnv to match glibc-2.2 */
