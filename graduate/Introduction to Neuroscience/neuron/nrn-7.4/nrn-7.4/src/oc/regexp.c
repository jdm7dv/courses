#include <../../nrnconf.h>
/* /local/src/master/nrn/src/oc/regexp.c,v 1.1.1.1 1994/10/12 17:22:13 hines Exp */
/*
regexp.c,v
 ...
 * moved regexp.c from project 'neuron' to 'hoc'
 * 
