...
#ifndef _doubledefs_h
#define _doubledefs_h 1


// equality operator
#ifndef doubleEQ
#define doubleEQ(a, b)  ((a) == (b))
#endif

// less-than-or-equal
#ifndef doubleLE
#define doubleLE(a, b)  ((a) <= (b))
#endif

// comparison : less-than -> < 0; equal -> 0; greater-than -> > 0
#ifndef doubleCMP
#define doubleCMP(a, b) ( ((a) <= (b))? (((a) == (b))? 0 : -1) : 1 )
#endif

// hash function
#ifndef doubleHASH
extern unsigned int hash(double );
#define doubleHASH(x)  hash(x)
#endif
