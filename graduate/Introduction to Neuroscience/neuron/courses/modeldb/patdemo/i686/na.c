	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  hoc_register_dparam_size(_mechtype, 4);
 	...
 	ivoc_help("help ?1 na /home/ted/ms/sdsccrs/2008/crsdev/course/modeldb/patdemo/i686/na.mod\n");
...
static int  rates (  _lvm )  
 ...
 _la = trap0 (  _lvm , tha , Ra , qa ) ;
   ...
   minf = _la / ( _la + _lb ) ;
   _la = trap0 (  _lvm , thi1 , Rd , qi ) ;
   _lb = trap0 (  - _lvm , - thi2 , Rg , qi ) ;
